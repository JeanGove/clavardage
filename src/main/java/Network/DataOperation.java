...
public class DataOperation extends Thread{
			...
			if(this.c.hasUser()){ //Check if the Controller is well defined
				if(argv[0].equals("connecting")){
					...
					System.out.println("whoIam");
                                ...
                                else if(argv[0].equals("serverDisconnect")){ //depreciated
					this.onServerDisconnect(argv);
    ...
    private void onServerDisconnect(String[] argv) {
        this.c.handleServerDisconnection(this.addr);
    }
